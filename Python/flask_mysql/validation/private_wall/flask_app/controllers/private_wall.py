...
def successful_login():
    ...
    user = User.single_user_w_messages(data)
    senders = []
    for message in user.messages_for_user:
        senders.append(user.single_user(message.user_id_sent))
    print('****************')
    print(senders)
    return render_template('wall.html', user = user, senders = senders)
